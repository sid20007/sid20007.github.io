      ...
      >
        ...
        <div className="relative z-10 mt-8 flex items-center justify-between pt-5 border-t border-white/[0.04]">
          ...
          {project.live && (
            ...
            >
              Visit <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" /></svg>
            </a>
          )}
        </div>
      </motion.div>
